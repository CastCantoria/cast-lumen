...
// Configuration EmailJS - Version développement sécurisée
const emailConfig = {
  SERVICE_ID: 'service_cast_lumen',
  TEMPLATE_ID: 'template_cast_lumen', 
  PUBLIC_KEY: 'YOUR_PUBLIC_KEY_HERE', // À remplacer par votre clé réelle
};
...
// Service email avec fallbacks pour le développement
const emailService = {
