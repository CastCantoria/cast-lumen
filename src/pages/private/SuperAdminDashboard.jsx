    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { label: "Utilisateurs", color: "green", value: 0 },
            { label: "Événements", color: "red", value: 0 },
            { label: "Morceaux", color: "purple", value: 0 },
            { label: "Admins", color: "orange", value: 0 }
          ].map((stat, index) => (
            <div
              key={index}
              className={`text-center p-6 bg-${stat.color}-50 rounded-lg border border-${stat.color}-200`}
            >
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {[
            { title: "Gestion Utilisateurs", text: "Ajoutez, modifiez ou supprimez des utilisateurs et gérez leurs permissions." },
            { title: "Événements", text: "Créez et organisez des concerts, répétitions et activités." },
            { title: "Répertoire", text: "Gérez le catalogue musical avec partitions et informations." },
            { title: "Administration", text: "Configurez les paramètres système et surveillez l'activité." }
          ].map((item, i) => (
            <div key={i} className="p-5 bg-gray-50 rounded-lg border border-gray-200">
              <h3 className="font-semibold text-green-600 mb-3 text-lg">{item.title}</h3>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              <div className="text-sm text-gray-600">
                {navigationItems.find((i) => i.id === activeSection)?.title || "Dashboard"}
              </div>
