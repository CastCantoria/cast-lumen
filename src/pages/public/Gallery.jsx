...
const Gallery = () => {
  ...
  useEffect(() => {
    setGalleryMedia([
      ...
      // PHOTOS - COMMUNAUTÉ
      {
        ...
        type: 'photos',
        category: 'communauté',
        src: '/images/gallery/galerie3.jpg',
        thumbnail: '/images/gallery/galerie3.jpg',
      ...
      },
      {
        ...
        type: 'photos',
        category: 'communauté',
        src: '/images/gallery/galerie4.jpg',
        thumbnail: '/images/gallery/galerie4.jpg',
        title: 'Rencontre Informelle',
        description: 'Échanges entre membres après la répétition',
      ...
      },
      {
        ...
        description: 'Préparation pour le grand concert',
        date: '28 Mars 2024',
        author: 'Jean P.',
        duration: null,
        format: 'jpg',
      ...
      },
      {
        ...
        type: 'photos',
        category: 'portraits',
        src: '/images/gallery/galerie7.jpg',
        thumbnail: '/images/gallery/galerie7.jpg',
        title: 'Portrait - Alto',
        description: 'Membre de la section alto',
      ...
      },
      {
        ...
        type: 'photos',
        category: 'evenements',
        src: '/images/gallery/galerie8.jpg',
        thumbnail: '/images/gallery/galerie8.jpg',
        title: 'Cérémonie de Remerciement',
        description: 'Reconnaissance des bénévoles',
        date: '8 Mars 2024',
        author: 'C.A.S.T. Administration',
        duration: null,
        format: 'jpg',
        source: 'official'
      },
      ...
      },
      {
        ...
        type: 'photos',
        category: 'portraits',
        src: '/images/membres/pcast16.jpg',
        thumbnail: '/images/membres/pcast16.jpg',
        title: 'Portrait Membre - Soprane',
        description: 'Notre soprane en répétition',
        date: '20 Janvier 2024',
        author: 'Lucie M.',
        duration: null,
        format: 'jpg',
      ...
      },
      {
        ...
        type: 'photos',
        category: 'communauté',
        src: '/images/membres/pcast17.jpg',
        thumbnail: '/images/membres/pcast17.jpg',
        title: 'Moment de Partage',
        description: 'Échanges entre choristes',
        date: '5 Février 2024',
        author: 'Marc T.',
        duration: null,
        format: 'jpg',
      ...
      // PARTITIONS (utilisant des images comme placeholder)
      {
        id: 25,
        type: 'photos',
        category: 'partitions',
        src: '/images/partition-sacree.jpg',
        thumbnail: '/images/partition-sacree.jpg',
        title: 'Partition - Cantique Sacré',
        description: 'Arrangement pour chœur à 4 voix',
        date: '15 Mars 2024',
        author: 'Chef de Chœur',
        duration: null,
        format: 'jpg',
        source: 'official'
      }
  ...
  const displayMedia = viewAll ? filteredMedia : filteredMedia.slice(0, 12);
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 pt-20">
      ...
      <section className="bg-gradient-to-r from-purple-900 via-blue-800 to-purple-900 text-white py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto text-purple-100 leading-relaxed">
            Découvrez {totalMediaCount} médias de C.A.S.T. Cantoria
          </p>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          ...
          {/* Bouton Voir Tout */}
          {filteredMedia.length > 12 && !viewAll && (
