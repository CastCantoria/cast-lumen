    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        <p className="text-gray-600">
          Administrez les membres et leurs permissions • Votre rôle: 
          <span className="font-semibold capitalize ml-1">{userProfile?.role}</span>
        </p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 mb-6 border border-gray-200">
        ...
        <div className="flex justify-between items-center">
          <div className="flex space-x-3">
            ...
            <button
              onClick={exportToCSV}
              className="bg-green-600 text-white py-2 px-4 rounded-lg hover:bg-green-700 transition-colors duration-300 flex items-center text-sm"
            >
              📊 Exporter CSV
            </button>
          </div>
